...
import static com.szaumoor.utils.Bools.allFalse;
...
public final class PaymentMethodTests {
    ...
    public static void setUp() {
        ...
        var pass = UserPass.of(new char[]{'1', 'b', '5', '1', 'a', 's', 'o', 'n', '1'});
    ...
    public void cannotSetNullName() {
        ...
        assertTrue(allFalse(setting, nulled), "Setting to null succeeded unexpectedly");
    }
    ...
    public void cannotSetBlankName() {
        ...
        assertTrue(allFalse(isBlank, setting), "Setting to blank string succeeded unexpectedly");
    }
