...
import com.rumpel.rumpeldesktop.fxutils.Tables;
...
import static com.szaumoor.rumple.model.entities.ItemBill.sum;
import static javafx.collections.FXCollections.observableArrayList;

/**
 * Controller for the item bill dialog and all the functions
 */
public final class ItemBillDialogController implements Initializable {
    /**
     * A convenience record for a tag and a boolean indicating if it is checked, to track checkboxes better.
     *
     * @param checkedProperty The JavaFX boolean property for the checkbox
     * @param tagProperty     The JavaFX object property for the tag
     */
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        //Tables.sortByMoneyAmount(priceCol);
    ...
    private void updateTotal() {
        lblTotal.setText("Total: " + Money.formatCurrency(sum(tableView.getItems()), bill.getCurrency()));
    }
